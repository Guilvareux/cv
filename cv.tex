...
\begin{entrylist}
	...
	guided by abstract, high-level goals.\\
		\texttt{Prolog}\slashsep\texttt{Rust}\slashsep\texttt{OSM}\slashsep\texttt{Openstack}\slashsep\texttt{Orchestration}\slashsep\texttt{Linux}}
	\entry
	{2023 -- 2023}
...
\begin{entrylist}
	...
	{Lancaster University}
	{Working to design and implment an extensible intent handler using semantic
	web technologies and an intent handler to enable autonomic network
	management for 5G network infrastructure.}
	\entry
	{2016 -- 2020}
	{BSc (Hons) Computer Science \textit{(2:1)}}
	{Lancaster University}
	{Thesis included the creation and evaluation of an virtual reality
...
\begin{minipage}[t]{0.35\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	\cvsect{Hobbies}\\
	\cvtag{Homelab}\cvtag{Motorbikes}\cvtag{Coffee}\cvtag{Cooking}
	\cvtag{Energy Generation}\cvtag{Music}
	\divider\\
...
\begin{minipage}[t]{0.6\textwidth}
	...
	to interpret abstract goals as policies which can construct constraint
	satisfaction problems and generate network configurations. Once a network
